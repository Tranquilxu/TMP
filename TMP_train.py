...
if __name__ == "__main__":
    ...
    top1, top5 = zero_shot_test_model(clip_model, test_loader, taglist_label)
    print(f"zero shot:  | top1 : {top1[0]}  | top5 : {top5[0]}")
    ...
    for epoch in range(args.epochs):
        ...
        # print("learned_text_epoch = ", learned_text_epoch.size())
